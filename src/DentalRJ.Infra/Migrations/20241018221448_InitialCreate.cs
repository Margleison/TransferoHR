    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DentistriesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    DentistsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DentistDentistry", x => new { x.DentistriesId, x.DentistsId });
                    table.ForeignKey(
                        name: "FK_DentistDentistry_Dentist_DentistsId",
                        column: x => x.DentistsId,
                        principalTable: "Dentist",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DentistDentistry_Dentistry_DentistriesId",
                        column: x => x.DentistriesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DentistDentistry_DentistsId",

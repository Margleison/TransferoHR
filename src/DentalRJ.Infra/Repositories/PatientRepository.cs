...
{
    public class PatientRepository : NamedEntityRepository<Patient, PatientParams>, IPatientRepository
    {
        ...
        public async override Task<IEnumerable<Patient>> GetAllAsync(PatientParams param)
        {
